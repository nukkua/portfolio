<script>
    ...
    let steps = [
        {
            name: "Inventory Managment for a Restaurant",
            icon: "fa-solid fa-cart-shopping",
            description: "The application includes features for login, viewing daily menus, managing dishes, ingredients, reports and orders. Using React Router for page navigation and error handling through a page NotFound!"
	},
        {
            name: "Ultimate Todos",
        ...
        },
        {
            ...
            description: "A pokedex using all the SvelteKit ecosystem",
	},
    ];
...
let benefits = [
    {
        ...
        description:
            "I taught myself to code using free online resources and absolutely fell in love with the creativity and problem solving that is involved in developing and engineering innovative new online experiences. Starting of with JavaScript, HTML & CSS and evolving my knowledge base to include JavaScript frameworks, backend programming, design",
    },
    {
        name: "continuous learning ability",
        description:
            "Technology and tools evolve rapidly. I'm always eager and capable of learning and adapting to new technologies, allowing me to stay at the forefront and deliver up-to-date and effective solutions.",
    },
    {
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Marco Antonio</span> Justiniano Salazar
                <br />Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (SvelteKit), TailwindCSS, Python + Flask and Go + Chi & MySQL or Firebase/Firestore! </p>
            <button
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    Restaurant Top-Burger needed a web application <strong
                        class="text-violet-400"
                        >with Python as Backend with Flask and React</strong
                    > The application includes features for login, viewing daily menus, managing dishes, ingredients, reports and orders. Using React Router for page navigation and error handling through a page NotFound!"
            ...
            <Step step={steps[1]}>
                <p>
                    Ultimate Todos is a Full Stack <strong
                        class="text-violet-400">Svelte</strong
                    >,
                    <strong class="text-violet-400">SvelteKit</strong
                    >
		    CRUD application
                    manage a tidy and efficacious todo
                    list               
		</p>
            </Step>
            <Step step={steps[2]}>
